...
import com.liyihuanx.module_base.adapter.BaseRecyclerAdapter
 ...
 * @description: 类的描述
 */
class TwoDataBindingAdapter : BaseRecyclerAdapter<ChapterBean, ItemTwoBinding>(R.layout.item_two) {
